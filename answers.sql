...
SELECT m.name, b.name, b.founded FROM brands AS b JOIN models AS m ON b.name = m.brand_name WHERE b.name IS NOT NULL;
...
SELECT b.name, b.founded FROM brands AS b LEFT JOIN models AS m ON b.name = m.brand_name WHERE b.name NOT IN (SELECT brand_name FROM models);
